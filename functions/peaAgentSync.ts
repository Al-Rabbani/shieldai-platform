...
export default async function handler(req: Request): Promise<Response> {
  ...
  try {
    ...
    const record = await dbCreate(AGENT_APP, "Application", serviceToken, {
      ...
      registration_email_sent:    body.registration_email_sent    === true || body.registration_email_sent === "true" || false,
      payment_email_sent:         body.payment_email_sent         === true || body.payment_email_sent === "true" || false,
      kyc_verified:               body.kyc_verified               === true || body.kyc_verified === "true" || false,
      day_90_start:               body.day_90_start               || null,
      portal_user_id:             body.portal_user_id             || null,
      last_weekly_sent:           body.last_weekly_sent           || null,
      weekly_sends_this_month:    body.weekly_sends_this_month    || 0,
      weekly_sends_month:         body.weekly_sends_month         || "",
      notes:                      body.notes                      || "",
