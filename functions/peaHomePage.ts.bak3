...
const CAPS=[
  ...
  ["pu","🔒","Secure Document Vault","04","Encrypted document storage with authenticity verification on upload.","Documents are encrypted with AES-256. The system scans each upload for authenticity — extracting structured data and flagging potential issues. Only assigned reviewers can access documents, with every view logged forensically."],
...
const FAQS=[
  ...
  ["What is the application fee?","The application fee is £1,200 (£1,000 + £200 VAT). This includes AI pre-screening, expert panel evaluation, encrypted document management, real-time status tracking, and — if approved — a QR-verified endorsement certificate and lifetime ecosystem access."],
...
<meta name="description" content="Sovereign AI-powered platform for the UK Innovator Founder Visa endorsement ecosystem. Invitation-only. Zero compromise."/>
...
<div class="nw">
  ...
  <div class="tb">
    ...
    <div class="td"></div>
    <span class="tm" id="tmsg">AI Assessment Engine · v3.2 · All dimensions operational</span>
...
<section class="hr" id="hero-section">
  ...
  <div class="hc">
    <div>
      ...
      <p class="hd">A proprietary AI-powered digital endorsement infrastructure platform designed to support the UK innovation and business endorsement ecosystem through advanced technology, compliance automation, secure digital workflows, and institutional-grade assessment support systems.</p>
      <p class="hdi">Prime Endorsement Authority is not a UK Home Office Approved Endorsing Body. We provide advanced AI infrastructure, compliance technology, and institutional workflow support to officially designated Home Office Approved Endorsing Bodies and regulated partner institutions.</p>
      <div class="hca">
      ...
      <div class="htr">
        ...
        <div class="trb"><span class="trt">⚡ AI/ML Engine v3.2</span><span class="trs">94% precision · Real-time</span></div>
      </div>
    </div>
        ...
        <div class="db">
          <div id="dt-command">
            ...
            <div class="dss">
              ...
              <div class="dsc"><span class="dsv">94%</span><span class="dsl">AI Score</span></div>
...
<div class="ss2">
  <div class="sg">
    ...
    <div class="si rv rv3"><span class="sn"><span class="cu" data-t="94">0</span><span class="sf">%</span></span><span class="sl">AI Assessment Precision</span><span class="su">ML Engine Accuracy</span></div>
  </div>
  <div class="syb">
...
<section class="sec" id="fees">
  <div class="sei">
    ...
    <div class="fc2 rv">
      ...
      <ul class="ff">
        ${["Full AI-powered pre-screening assessment","Expert multi-reviewer panel evaluation","Encrypted document vault & AI verification","Real-time application status tracking","QR-verified endorsement certificate (if approved)","Lifetime access to post-endorsement ecosystem"].map(f=>`<li class="fi2"><span class="fck">✦</span><span>${f}</span></li>`).join("")}
      </ul>
...
<footer class="fo">
  <div class="fg">
    <div>
      ...
      <p class="ftg">Sovereign AI-powered infrastructure for the UK Innovator Founder Visa endorsement ecosystem. Invitation-only. Zero compromise.</p>
  ...
  <div class="fbt"><span class="fcp">© 2026 Prime Endorsement Authority. All rights reserved. Regulated infrastructure. Invitation-only platform.</span><span class="fcp">Powered by sovereign AI · UKVI aligned · ISO 27001</span></div>
</footer>
